            ...
            <ul className="mt-9 flex items-center space-x-3">
              <li>
                <a
                  href="#"
                  title=""
                  className="hover:bg-primary focus:bg-primary flex size-7 items-center justify-center rounded-full bg-foreground text-background transition-all duration-200"
                >
                  <svg
                    className="h-4 w-4"
